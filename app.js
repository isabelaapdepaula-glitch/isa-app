const K="isa_app_data_v13",K12="isa_app_data_v12";
...
function blank(){return{version:13,habits:[],habitCompletions:{},prayers:[],prayerCompletions:{},tasks:[],taskCompletions:{},routine:[],reviews:{},customCategories:[],profilePhoto:"",profilePhotoSettings:{zoom:100,x:50,y:50},lastBackupAt:""}}
function load(){let r=localStorage.getItem(K);if(r)try{return JSON.parse(r)}catch{};let s=blank(),old=localStorage.getItem(K12);if(old)try{let o=JSON.parse(old);s={...s,...o,version:13,routine:o.routine||[]}}catch{};localStorage.setItem(K,JSON.stringify(s));return s}
...
importBackupInput.addEventListener("change",async e=>{
  ...
  try{
    ...
    S={...blank(),...incoming,version:13,reviews:incoming.reviews||{}};
    save();
    renderSettings();
